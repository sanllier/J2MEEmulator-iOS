...
#   else /* !M3G_NGL_CONTEXT_API */
    ...
    */
    ...
    // iOS and Android always have hardware renderers
#if defined(M3G_TARGET_ANDROID) || defined(M3G_TARGET_GENERIC)
    m3g->supportAntialiasing = M3G_TRUE;
    m3g->colorMaskWorkaround = M3G_FALSE;
    m3g->twoSidedLightingWorkaround = M3G_FALSE;
#else
    if (info && strstr((const char *)info, "HW")) {
        m3g->supportAntialiasing = M3G_TRUE;
    }
    else {
...
#endif /* M3G_TARGET_GENERIC || M3G_TARGET_ANDROID */
