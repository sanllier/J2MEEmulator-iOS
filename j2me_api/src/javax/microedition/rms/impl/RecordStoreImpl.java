...
public class RecordStoreImpl extends RecordStore {
	...
	public void closeRecordStore() throws RecordStoreException {
		...
		System.out.println("RecordStore " + recordStoreName + " closed");
	}
	...
	public int addRecord(byte[] data, int offset, int numBytes) throws RecordStoreException {
		...
		System.out.println("Record " + recordStoreName + "." + nextRecordID + " added");
		return nextRecordID;
	}
	...
	public void deleteRecord(int recordId) throws RecordStoreException {
		...
		System.out.println("Record " + recordStoreName + "." + recordId + " deleted");
	}
	...
	public void setRecord(int recordId, byte[] newData, int offset, int numBytes)
		...
		System.out.println("Record " + recordStoreName + "." + recordId + " set");
	}
	...
	public RecordEnumeration enumerateRecords(RecordFilter filter,
		...
		System.out.println("Enumerate records in " + recordStoreName);
