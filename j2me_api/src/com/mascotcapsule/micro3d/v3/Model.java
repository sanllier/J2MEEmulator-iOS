...
class Model {
	...
	Model(int vertices, int numBones, int patterns, int numTextures,
		...
		// Sentinel vertex (used by applyPattern to hide polygons):
		// All 3 coords at 0 — all triangle vertices are the same point = zero-area
		// triangle = no fragments rasterized. (NaN/INFINITY don't clip on Apple GPU)
		// Default is already 0 from FloatBuffer.allocate, nothing to do.
